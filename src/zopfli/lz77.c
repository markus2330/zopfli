...
extern ZopfliHash* ZopfliInitHashAndStuff(size_t windowstart, const unsigned char* in, size_t instart, size_t inend);
...
void ZopfliLZ77Greedy(ZopfliBlockState* s, const unsigned char* in,
  ...
  h = ZopfliInitHashAndStuff(windowstart, in, instart, inend);
